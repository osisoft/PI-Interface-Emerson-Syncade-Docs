...
4. For event frames, you can configure the following additional settings.
    ...
    | DefaultProperty[x].Trigger | (Optional) Defines the expression that specifies which event(s) to use to get the value. <br><br>[Event,value="Recipe Header"][descript,value="Product Code"]
