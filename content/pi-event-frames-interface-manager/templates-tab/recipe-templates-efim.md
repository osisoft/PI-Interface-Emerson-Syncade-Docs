...
In the Master Recipe and Process Segment level recipe templates, the interface uses the Name field for the name of the Event Frame. The Event Frame does not store the Batch ID field. 
